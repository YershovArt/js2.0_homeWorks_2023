...
function f6() {
    let name = document.querySelector('.i-61').value;
...
function f7() {
    let name = document.querySelector('.i-7').value;
    let out = 0;
    for (const key in a7) {
        if (key === name) {
            out = 1;
...
function f8() {
    let name = document.querySelector('.i-8').value;
    let out = 0;
    for (const key in a8) {
        if (key === name) {
            out = a8[key];
...
function f9() {
    let name = document.querySelector('.i-9').value;
    let out = '';
    for (const key in a9) {
        if (a9[key] == name) {
            out += `${a9[key]} `;
...
function f11() {
    let name = document.querySelector('.i-11').value;
...
function f12() {
    let name = document.querySelector('.i-12').value;
