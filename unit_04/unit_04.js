...
function f4() {
    ...
    document.querySelector('.out-4').textContent = checkBox4.checked
}
...
function f5() {
    ...
    if (checkBox5.checked) {
        document.querySelector('.out-5').textContent = checkBox5.value;
    } else {
...
function f14() {
    ...
    document.querySelector('.out-14').textContent = t14;
}
