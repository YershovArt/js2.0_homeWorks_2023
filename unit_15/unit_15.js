...
const f4 = () => {
    ...
    let inputData = document.querySelector('.i-4').value;
    elem.textContent = s4.has(inputData);;
}
...
const f6 = () => {
    ...
    let setS6 = new Set(a6);
    console.log(setS6);
    elem.textContent = setS6.size;
}
...
const f7 = () => {
    ...
    let inputData = document.querySelector('.i-7').value;
    let uniqueData = new Set(inputData)
    if (inputData.length === uniqueData.size && inputData.length > 6) {
        elem.textContent = 1;
    } else {
        elem.textContent = 0;
    }
...
const f10 = (out_set, elem) => {
    ...
    return document.querySelector(elem).textContent = out;
}
