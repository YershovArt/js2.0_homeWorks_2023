...
function f11() {
    let elem = +document.querySelector('.i-11').value;
    let out11 = document.querySelector('.out-11');
    out11.textContent = d11.indexOf(elem);
}
...
function f14() {
    ...
    document.querySelector('.out-14').textContent = d14;
    showArr('.out-14', d14);
}
...
function f15() {
    ...
    if (d15.indexOf(elem) === -1) d15.push(elem);
...
function f18() {
    ...
    elem.textContent = d18.includes(input);
}
