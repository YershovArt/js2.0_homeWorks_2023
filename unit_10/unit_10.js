...
let ar1 = [1, true, 'hi', 31, false, 'taurus'];
function f1() {
...
let ar2 = [1, true, 'hi', 31, false, 'taurus'];
function f2() {
    let out = '';
...
function f10() {
    ...
    elem.textContent = `${ar10[1] + ar10[ar10.length - 1]}`;
}
...
function f11() {
    let elem = document.querySelector('.out-11');
    let out = '';
    let t = ar11[2];
    ar11[2] = ar11[4];
    ar11[4] = t;
...
function f12() {
    let elem = document.querySelector('.out-12');
    let out = '';
    let t = ar12[0];
...
function f13() {
    let elem = document.querySelector('.out-13');
    let out = '';
    let i = 0;
    while (i < ar13.length) {
        out += `${i} ${ar13[i]} `;
...
function f14() {
    let elem = document.querySelector('.out-14');
    let out = '';
    let i = ar14.length;
    while (i > 0) {
        i--;
...
function f15() {
    let elem = document.querySelector('.out-15');
    let out = '';
    let i = 0;
    while (i < ar15.length) {
...
function f16() {
    let elemOdd = document.querySelector('.out-16-odd');
    let elemEven = document.querySelector('.out-16-even');
    let i = 0;
    let out = '';
    ar16_odd = [];
    ar16_even = [];
    ...
    for (let k = 0; k < ar16_even.length; k++) {
        out += `${ar16_even[k]} `;
    }

    elemEven.textContent = out;
...
function f17() {
    let elem = document.querySelector('.out-17');
    let i = 0;
    let counter = 0;
    while (i < ar17.length) {
        if (ar17[i] > 3) {
...
function f18() {
    let elem = document.querySelector('.out-18');
    let i = 1;
    let max = ar18[0];
    while (i < ar18.length) {
        if (ar18[i] > max) {
...
function f19() {
    let elem = document.querySelector('.out-19');
    let i = 1;
    let min = ar19[0];
    while (i < ar19.length) {
        if (ar19[i] < min) {
