...
function t6() {
	data = '';
	let limit = +document.querySelector('.i-6').value
...
function t7() {
	data = '';
	let initialValue = +document.querySelector('.i-7').value;
...
function t8() {
	data = '';
	let initialValue = +document.querySelector('.i-81').value;
	let limit = +document.querySelector('.i-82').value;
	for (let i = initialValue; i <= limit; i += 1) {
		data += i + '_';
	}
...
function t9() {
	data = '';
	let firstValue = +document.querySelector('.i-91').value;
	let secondValue = +document.querySelector('.i-92').value;
...
function t13() {
	let inp = document.getElementsByClassName('i-13');
...
function t14() {
	inp = document.getElementsByClassName('i-14');
	for (let i = 0; i < inp.length; i++) {
		if (inp[i].checked) {
			document.querySelector('.out-14').textContent = inp[i].value
		}
	}
}
