...
function f5() {
    ...
    document.querySelector('.out-5').textContent = out4;
}
...
function f7() {
    blocks7 = document.querySelectorAll('.out-7');
    let i = 0;
...
function f19() {
    ...
    let attr = '';
    while (i < p.length) {
        attr += `${p[i].getAttribute('data-b')} `;
        i++;
    }
    out19.textContent = attr;
